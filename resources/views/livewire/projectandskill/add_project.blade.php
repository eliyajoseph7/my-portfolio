<div class="fixed inset-0 overflow-hidden {{$project}}">
            ...
            <div class="pointer-events-auto relative w-screen max-w-lg">
                ...
                <div class="flex h-full flex-col overflow-y-scroll bg-white pb-6 shadow-xl">
                    <div class="px-4 py-10 sm:px-6 bg-blue-900 text-white">
                        <button type="button" class="float-right rounded-md text-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white" wire:click="hideAddProject()">
                        ...
                        <h2 class="text-2xl font-serif text-x" id="add-project">Add New Project</h2>
                    </div>
