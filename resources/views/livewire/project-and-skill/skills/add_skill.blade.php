...
<x-add-project-skill class="fixed inset-0 overflow-hidden {{$skill_flag}} z-30" compname="skill" :actions="$action">
    <form class="p-2" method="dialog" wire:submit.prevent="{{ lcfirst($action) }}Skill">
