...
<div class="container mx-auto mb-5">
    <div class="block border-2 shadow-xs relativ pb-32 bg-white rounded-xl">
        ...
        <div class="flex absolute top-32 lg:top-40">
            ...
            <div class="grid lg:grid-cols-3 lg:grid-flow-col lg:gap-10 absolute top-24 lg:top-36 lg:left-96 lg:space-x-72">
                <div class="colspan-2 lg:ml-10 w-96 grid grid-flow-row">
                    <h3 class="w-full text-3xl font-bold uppercase cursor-pointer px-4 font-serif">Eliya Joseph</h3>
                </div>
                <div class="colspan-1 grid lg:grid-rows-1 grid-flow-col gap-2 lg:gap-4 px-4">
